...
public class TratadorController {
    ...
    @GetMapping
    public ResponseEntity<List<TratadorSaveDTO>> getTratador(){
        try{
            List<TratadorSaveDTO> tratadores = tratadorService.getAllTratador();
            ...
            logger.error("Não foi possivel buscar o tratador", e);
